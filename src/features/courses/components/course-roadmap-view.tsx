                      ...
                      >
                          ...
                          <div>
                            ...
                            {lesson.estimatedMinutes && (
                              <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                Thời gian ước tính: {lesson.estimatedMinutes} phút
                              </p>
                            )}
                          </div>
                        </div>
                        ...
                        {!isLocked && (
                          <Link
                            ...
                            className="inline-flex rounded-md border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-900 transition hover:bg-slate-50 hover:text-indigo-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 dark:hover:text-white"
                          >
