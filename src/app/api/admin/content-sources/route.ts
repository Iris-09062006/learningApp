...
import { ContentPipelineError, uploadContentSource } from "@/features/content-pipeline/services/content-pipeline-service";
...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      { success: true, data: await uploadContentSource(file) },
